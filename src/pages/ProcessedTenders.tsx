...
const EXCEL_COLUMNS: ExcelColumn<any>[] = [
  // File / upload
  { key: "filename", label: "File", width: 200, editable: false, group: "file" },
  { key: "uploaded_at_fmt", label: "Caricato il", width: 140, editable: false, group: "file" },
  { key: "upload_status", label: "Stato file", width: 110, editable: false, group: "file" },
  // Appalto
  { key: "project_id", label: "ID Progetto", width: 110, editable: false, group: "appalto" },
  { key: "nome_appalto", label: "Nome appalto", width: 220, group: "appalto" },
  { key: "cig_appalto", label: "CIG", width: 110, group: "appalto" },
  { key: "cup", label: "CUP", width: 110, group: "appalto" },
  { key: "descrizione_appalto", label: "Descrizione appalto", width: 280, group: "appalto" },
  { key: "value_eur", label: "Valore €", width: 110, group: "appalto" },
  { key: "phase", label: "Fase", width: 110, group: "appalto" },
  { key: "appalto_location", label: "Località appalto", width: 160, group: "appalto" },
  { key: "categoria_progetto", label: "Categoria progetto", width: 160, group: "appalto" },
  { key: "categorie_og", label: "Categorie OG", width: 140, group: "appalto" },
  { key: "tipo_intervento", label: "Tipo intervento", width: 160, group: "appalto" },
  { key: "committente_tipo", label: "Committente", width: 140, group: "appalto" },
  { key: "procedura_gara", label: "Procedura gara", width: 150, group: "appalto" },
  { key: "finanziamento", label: "Finanziamento", width: 140, group: "appalto" },
  { key: "data_appalto", label: "Data appalto", width: 120, group: "appalto" },
  { key: "data_fine_lavori", label: "Fine lavori", width: 120, group: "appalto" },
  { key: "termine_offerta", label: "Termine offerta", width: 130, group: "appalto" },
  { key: "note_appalto", label: "Note appalto", width: 260, group: "appalto" },
  // Lead
  { key: "lead_company", label: "Azienda", width: 200, group: "lead" },
  { key: "lead_surname", label: "Referente", width: 140, group: "lead" },
  { key: "lead_email", label: "Email", width: 200, group: "lead" },
  { key: "lead_number", label: "Telefono", width: 130, group: "lead" },
  { key: "lead_category", label: "Categoria lead", width: 130, group: "lead" },
  { key: "entity_role", label: "Ruolo", width: 140, group: "lead" },
  { key: "quality_status", label: "Qualità", width: 100, group: "lead" },
  { key: "website", label: "Web", width: 160, group: "lead" },
  { key: "street", label: "Indirizzo", width: 200, group: "lead" },
  { key: "cap", label: "CAP", width: 80, group: "lead" },
  { key: "lead_city", label: "Città", width: 130, group: "lead" },
  { key: "lead_province", label: "Prov.", width: 70, group: "lead" },
  { key: "country", label: "Paese", width: 100, group: "lead" },
  { key: "note", label: "Note lead", width: 260, group: "lead" },
];
